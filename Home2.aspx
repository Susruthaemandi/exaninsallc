...
<head>
    ...
    <!-- Page Title -->
    <title>EXANINSA LLC - Insurance Agency HTML Template</title>
    <!-- Favicon Icon -->
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    ...
    <link href="css/custom.css" rel="stylesheet" media="screen">
     ...
     <link href="Fonts/fa-brands-400.woff2" rel="stylesheet">
<link href="Fonts/fa-regular-400.woff2" rel="stylesheet">
<link href="Fonts/fa-solid-900.woff2" rel="stylesheet">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 order-lg-2 order-1">
                    <div class="about-content">
                        <!-- Section Title start -->
                        <div class="section-title">
                            <h3 class="wow fadeInUp" data-wow-delay="0.25s">About EXANINSA LLC</h3>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="consulations-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime">5 Years of Excellence in The Insurance Industry.</h2>
                        </div>
                        <!-- Section Title end -->
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime">Why you should choose EXANINSA LLC ?</h2>
                    </div>
                    <!-- Section Title end -->
                        ...
                        <div class="support-team-section wow fadeInUp" data-wow-delay="1.0s">
                            ...
                            <div class="support-team-body">
                                ...
                                <ul class="support-team-contact">
                                    ...
                                    <li><a href="#" class="support-mail-btn">info@domain.com</a></li>
                                </ul>
                            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12">
                        ...
                        <p>Copyright 2024 <strong>EXANINSA LLC.</strong> All Rights Reserved.</p>
